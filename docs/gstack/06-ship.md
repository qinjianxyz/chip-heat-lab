...
- Record the 90-second native-app demo video.
- Founder-review `docs/submission-copy.md`.
- Add the approved demo video URL to the README and submission form.
- Do one final visual polish pass only after watching the recording.
